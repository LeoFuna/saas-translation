  ...
  return (
    <div className="p-5">
      { !loading && !messages?.length && (
        <div className="flex flex-col justify-center text-center items-center p-20 rounded-xl space-y-2 bg-indigo-400
      ...
      { messages?.map((message) => {
        ...
        return (
          <div key={message.id} className="flex my-2 items-end">
            <div
              className={`flex flex-col relative space-y-2 p-4 w-fit line-clamp-1 mx-2
              rounded-lg ${
                isSender
      ...
      {/* Referencia para rolar o chat para baixo a cada nova msg */}
