...
import { LanguagesSupportedMap, LanguaguesSupprted, useLanguageStore, useSubscriptionStore } from "../../store/store"
...
export default function LanguageSelect() {
  ...
  return isChatPage && (
    <div>
      <Select
        onValueChange={(value: LanguaguesSupprted) => setLanguage(value)}
      >
